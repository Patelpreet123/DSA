...
## Hard
Given a Singly linked list, reverse&nbsp;every&nbsp;k node in the linked list and return the head of the modified list. If the node count is not a multiple of k then the left-out nodes at the end, should be considered as a group and must be reversed.
Examples:
